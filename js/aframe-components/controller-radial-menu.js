/**
 * Pie-Chart Radial Menu Component - DISABLED
 * Replaced by radial-menu-component.js
 */

AFRAME.registerComponent('controller-radial-menu', {
    init: function () {
        console.log('[PieMenu] Component DISABLED/DEPRECATED. If you see this, the legacy code is dead.');
    },
    tick: function () { },
    remove: function () { }
});
